...
$Self->{'DBCRUD::EventModulePost'}->{'9990-DBCRUD'} =  {
  'Event' => '.*(Add|Update|Delete|Export|Import|Copy)',
...
$Self->{'Frontend::Module'}->{'AdminDynamicFieldWebservice'} =  {
  ...
  'GroupRo' => [],
  'NavBarName' => '',
  'Title' => 'Admin configuration dialog for dynamic field types WebserviceText and WebserviceMultiselect'
};
...
$Self->{'Frontend::Module'}->{'AdminOAuth2TokenManagement'} =  {
  ...
  'Title' => 'AdminOAuth2TokenManagement'
};
...
$Self->{'Frontend::Output::FilterElementPost'}->{'ShowGoogleRecaptcha'} =  {
  'Module' => 'Kernel::Output::HTML::FilterElementPost::OutputFilterGoogleRecaptcha',
  'Templates' => {
    'CustomerLogin' => '1'
  }
};
...
$Self->{'GoogleCaptcha::SecretKey'} =  '6LeZ2TUqAAAAALUtevKAxsna0HE3SLhmNg_ILyv3';
$Self->{'GoogleCaptcha::SiteKey'} =  '6LeZ2TUqAAAAAJaDeSv5_bWTk1f4NqXW4e2MOgCI';
...
$Self->{'Ticket::EventModulePost'}->{'2000-TicketAllChildrenClosed'} =  {
  'Event' => 'TicketStateUpdate|TicketCreate',
